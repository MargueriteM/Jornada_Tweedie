calc_footprint_FFP <-
  function(lat, zm, z0, umean=NaN, ol, sigmav, ustar, wind_dir=NULL,
    ...
    #                 note (MM): displacement height can be estimated d ~ 0.67*canopy height https://www.licor.com/env/support/EddyPro/topics/displacement-height.html
    #                            US-Jo1 canopy height ~ 2m 
    #    z0        = Roughness length [m] - enter [NaN] if not known 
    #                  note (MM): roughtness length can be esimated z0 ~ 0.15*canopy height https://www.licor.com/env/support/EddyPro/topics/roughness-length.html 
