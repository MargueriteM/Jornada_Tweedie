...
load("~/Desktop/TweedieLab/Projects/Jornada/EddyCovariance/JER_Out_EddyPro_filtered/JER_flux_2010_EddyPro_Output_filtered_SD_20220124.Rdata")
...
flux_add <- fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2022/EddyPro_Out/eddypro_JER_2022_Jan_May_fluxnet_2022-06-14T170824_adv.csv",
...
# in 2022 the IRGA was swapped and they had differeent AGC values - keep AGC between 48 and 65
flux_add[FC_SSITC_TEST>1 | (CUSTOM_AGC_MEAN<48 & CUSTOM_AGC_MEAN>65), filter_fc := 1L]
...
# get rid of QC code >2 and low signal strength
flux_add[H_SSITC_TEST>1 | (CUSTOM_AGC_MEAN<48 & CUSTOM_AGC_MEAN>65), filter_H := 1L]
...
# get rid of QC code >2 and low signal strength
flux_add[LE_SSITC_TEST>1 | (CUSTOM_AGC_MEAN<48 & CUSTOM_AGC_MEAN>65), filter_LE := 1L]
...
write.table(flux_add_filter_sd,
            file="JER_flux_2022_EddyPro_Output_filtered_SD_PRELIMINARY.csv",sep=",", dec=".",
            row.names=FALSE)
...
save(flux_filter_sd_all,
     file="JER_flux_2010_EddyPro_Output_filtered_SD_20220531.Rdata")
