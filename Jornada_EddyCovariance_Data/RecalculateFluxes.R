...
flux.units.180 <- (fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2020/EddyPro_Out/eddypro_JER_2020_Jan_Dec_full_output_2021-12-21T142949_adv.csv",header=TRUE,skip=1))[1,]
...
flux10 <- fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2020/EddyPro_Out/eddypro_JER_2020_Jan_Dec_full_output_2021-12-21T142949_adv.csv", sep=",",skip=3,
                 header=FALSE, na.strings=c("-9999","-9999.0","NAN","#NAME?"),col.names=colnames(flux.units.180))

flux11a <- fread("/Volumes//SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2021/EddyPro_Out/eddypro_JER_2021_Jan_Jun_full_output_2022-01-18T173841_adv.csv", sep=",",skip=3,
                 header=FALSE, na.strings=c("-9999","-9999.0","NAN","#NAME?"),col.names=colnames(flux.units))

flux11b <- fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2021/EddyPro_Out/eddypro_JER_2021_Jul_Nov_full_output_2022-01-07T113327_adv.csv", sep=",",skip=3,
                 header=FALSE, na.strings=c("-9999","-9999.0","NAN","#NAME?"),col.names=colnames(flux.units.180))

flux11c <- fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2021/EddyPro_Out/eddypro_JER_2021_Dec_full_output_2022-09-16T135135_adv.csv", sep=",",skip=3,
                 header=FALSE, na.strings=c("-9999","-9999.0","NAN","#NAME?"),col.names=colnames(flux.units.180))

flux12 <- fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2022/EddyPro_Out/eddypro_JER_2022_JanSep_full_output_2022-10-14T112031_exp.csv", sep=",",skip=3,
                 header=FALSE, na.strings=c("-9999","-9999.0","NAN","#NAME?"),col.names=colnames(flux.units.180))
