...
load("~/Desktop/TweedieLab/Projects/Jornada/EddyCovariance/JER_Out_EddyPro_filtered/JER_flux_2010_EddyPro_Output_filtered_SD_20221231.Rdata")
...
# 2023 processed Jan - June and Jul-Dec (in ts_data_2)
 flux_add1 <- fread("/Users/memauritz/Library/CloudStorage/OneDrive-UniversityofTexasatElPaso/Bahada/Tower/EddyCovariance_ts/2023/EddyPro_Out/eddypro_JER_2023_JanJun_fluxnet_2024-03-15T230543_exp.csv",
...
# add Jul-Dec from ts_data_2 Open Path
flux_add2 <- fread("/Users/memauritz/Library/CloudStorage/OneDrive-UniversityofTexasatElPaso/Bahada/Tower/ts_data_2/2023/EddyPro_Out/OpenPath/eddypro_JER_2023_JulDec_tsdata2_Open_fluxnet_2024-06-07T162306_exp.csv",
                  sep=",", header=TRUE, na.strings=c("-9999"),fill=TRUE)
...
ggplot(biomet2023, aes(date_time,P_rain_1_1_1))+
  geom_line()
