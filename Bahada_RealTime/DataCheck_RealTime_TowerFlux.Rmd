...
flux_colnames <- fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/Flux/2020/Raw_Data/ASCII/dataL1_flux_2020.csv",
                  header = TRUE, skip=1,sep=",", fill=TRUE,
                 na.strings=c(-9999,"#NAME?"))[1,]

flux <- fread("/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/Flux/2020/Raw_Data/ASCII/dataL1_flux_2020.csv",
...
numericInput("range_flux","Adjust range of flux graph",
             min=NA,
             max=NA)
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
  ...
  ggplot(c[selected>=input$range_flux[[1]] & selected<=input$range_flux[[2]],], aes(date_time, selected))+
    geom_line()+
