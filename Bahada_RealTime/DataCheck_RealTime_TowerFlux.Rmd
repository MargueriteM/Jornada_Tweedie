---
title: "Jornada Bajada US-Jo1 Data Check"
...
basedir <- "/Users/memauritz/Library/CloudStorage/OneDrive-UniversityofTexasatElPaso/Bahada/Tower/"
...
<<<<<<< HEAD
cs650names <- colnames(read.table("dataL1_Soil_2023.csv", sep=",", skip=1,heade=TRUE))
cs650wide <- read.table("dataL1_Soil_2023.csv", sep=",", skip=4, col.names = cs650names, na.strings="-9999")
=======
<<<<<<< HEAD
...
cs650names <- colnames(read.table("dataL1_Soil_2023.csv", sep=",", skip=1,heade=TRUE))
cs650wide <- read.table("dataL1_Soil_2023.csv", sep=",", skip=4, col.names = cs650names, na.strings="-9999")
>>>>>>> ff494eeb9a4bef4dbfabaadc7984d7667bdf277f
>>>>>>> 43fd9de449fa03b67637fad313c8799cffe3c16d
