...
setwd("Z:/Research Data/Desert/Jornada/Bahada/Tower/Flux/2022/Raw_Data/ASCII")

flux_colnames <- fread("dataL1_flux_2022.csv",
                  header = TRUE, skip=1,sep=",", fill=TRUE,
                 na.strings=c(-9999,"#NAME?"))[1,]

flux <- fread("dataL1_flux_2022.csv",
...
#setwd(paste("Z:/Research Data/Desert/Jornada/Bahada/Tower/SoilSensor_CS650/",yeartocheck,"/Raw_Data/ASCII",sep=""))

setwd("Z:/Research Data/Desert/Jornada/Bahada/Tower/SoilSensor_CS650/2022/Raw_Data/ASCII")

# load headers of file and data
cs650names <- colnames(read.table("dataL1_Soil_2022.csv", sep=",", skip=1,heade=TRUE))
cs650wide <- read.table("dataL1_Soil_2022.csv", sep=",", skip=4, col.names = cs650names, na.strings="-9999")
