...
These graphs show most recent incoming climate data from the tower at the Jornada Bahada Site
...
wd_climate <- "/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/TowerClimate_met/2019/Raw_Data/ASCII"
wd_flux <- "/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/Flux/2019/Raw_Data/ASCII"
wd_ts <- '/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/EddyCovariance_ts/2019/Raw_Data/ASCII'
wd_ectm <- "/Volumes/SEL_Data_Archive/Research Data/Desert/Jornada/Bahada/Tower/SoilSensor_ECTM/2019/Raw_Data/ASCII"
  ...
  dateRangeInput("daterange", "Date range:",
   ...
   radioButtons("variable", "Variable:",
                c("Air Temperature (deg C)" = "airtemp",
                  ...
                  "Atmospheric Pressure (kPa)" = "atm_pressure",
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
renderPlot({
  c <- subset(climate, date >= input$daterange[[1]] & date <= input$daterange[[2]])
